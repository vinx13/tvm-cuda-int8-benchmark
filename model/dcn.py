# --------------------------------------------------------
# Adapated from https://github.com/msracver/Deformable-ConvNets/blob/d51075968c5fd40b37a55d20c8e945c1f181d529/faster_rcnn/symbols/resnet_v1_101_rcnn_dcn.py
# --------------------------------------------------------
...
class resnet_v1_101_rcnn_dcn(object):
    def __init__(self):
        """
...
def get_symbol(*args, **kwargs):
    return resnet_v1_101_rcnn_dcn().get_symbol(*args, **kwargs)
